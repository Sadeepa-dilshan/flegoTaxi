...
class insurencecertify extends StatefulWidget {
  const insurencecertify({super.key});

  @override
  State<insurencecertify> createState() => _CertificateverifyState();
}

class _CertificateverifyState extends State<insurencecertify> {
          ...
          child: Column(
            ...
            children: [
              ...
              details(
                  ...
                  text1: "Camera",
                  text2: 'Upload Insurance Certificate image'),
            ],
          ),
        ),
