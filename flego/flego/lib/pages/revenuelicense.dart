...
class Revlicence extends StatefulWidget {
  const Revlicence({super.key});

  @override
  State<Revlicence> createState() => _CertificateverifyState();
}

class _CertificateverifyState extends State<Revlicence> {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              text(
                  Tname: 'Revenue License duration',
                  Tsize: 20,
                  Tcolor: Colors.white,
                  Tweight: FontWeight.w400),
              SizedBox(
              ...
              details(
                  ...
                  text1: "Camera",
                  text2: 'Upload Revenue License image'),
